...
package com.android.systemui.zaprecent;
...
public class RecentController implements RecentPanelView.OnExitListener,
    ...
    private static final String TAG = "ZAPRecentsController";
    ...
    public RecentController(Context context, int layoutDirection) {
        ...
        mRecentContainer =
                (RelativeLayout) View.inflate(context, R.layout.zap_recent, null);
